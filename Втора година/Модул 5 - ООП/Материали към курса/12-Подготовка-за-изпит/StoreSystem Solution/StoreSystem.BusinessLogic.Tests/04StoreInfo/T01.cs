...
namespace StoreSystem.BusinessLogic.Tests._04StoreInfo
{
    public class T01
    {
        ...
        public void TestCreateStore()
        {
            ...
            var storeInfo = sut.GetMethod("StoreInfo");
            ...
            string checkMessage = (string)storeInfo.Invoke(arenaController, storeInfoArgs);
